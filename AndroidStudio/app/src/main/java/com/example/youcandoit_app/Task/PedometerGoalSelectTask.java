...
//            URL url = new URL("http://ycdi.cafe24.com:8080/YouCanDoIt/Android/PedometerGoalSelect.jsp");
            URL url = new URL("http://192.168.45.94:8080/YouCanDoIt/Android/PedometerGoalSelect.jsp");
            ...
            if (conn.getResponseCode() == conn.HTTP_OK) {
                ...
                receiveMsg = Integer.parseInt(buffer.toString());
