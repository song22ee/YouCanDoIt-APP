...
//            URL url = new URL("http://ycdi.cafe24.com:8080/YouCanDoIt/Android/NewToken.jsp");
            URL url = new URL("http://192.168.45.94:8080/YouCanDoIt/Android/NewToken.jsp");
            // http://ip주소:포트번호/이클립스프로젝트명/WebContent아래폴더/androidDB.jsp

            //전송할 데이터. GET방식으로 작성
            sendMsg = "mem_id=" + strings[0] + "&token=" + strings[1];
